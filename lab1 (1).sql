...
(101, 41, 1, '2017-01-01', '2017-04-03'),
(102, 42, 1, '2017-02-02', '2017-03-15'),
(103, 42, 1, '2017-02-14', '2017-05-14'),
(103, 43, 2, '2017-01-10', '2017-06-01'),
(104, 41, 1, '2017-01-10', '2017-03-15'),
(104, 44, 2, '2018-02-10', '2018-03-15');
...
('Hemanth', 'Mysore', 845975),
('manju', 'Mandya', 996589),
('Manya', 'Mysore', 869456),
('Teju', 'manglore', 265689),
('Yashu', 'Maddur', 914856);
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `p1`  AS SELECT `book`.`Book_Id` AS `Book_Id`, `book`.`Title` AS `Title`, `book`.`Publisher_Name` AS `Publisher_Name`, `book`.`Pub_Year` AS `Pub_Year` FROM `book` WHERE `book`.`Pub_Year` between '2002' and '2011' ;
